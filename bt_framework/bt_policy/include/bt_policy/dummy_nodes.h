...
BT::NodeStatus CheckPark(std::string name);

NodeStatus CheckTemperature();
NodeStatus SayHello();

NodeStatus IsTetherEnough();
NodeStatus AreAsvAndRovCloseEnough();
...
class FreeTether : public BT::SyncActionNode {
   public:
   FreeTether(const std::string& name, const BT::NodeConfig& config)
        : BT::SyncActionNode(name, config) {}
   ...
   // It is mandatory to define this static method.
   static BT::PortsList providedPorts() {
      return {BT::InputPort<std::string>("is_tether_free")};
 }
};

class IsObjectInspected : public BT::SyncActionNode {
   public:
   IsObjectInspected(const std::string& name, const BT::NodeConfig& config)
        : BT::SyncActionNode(name, config) {}
...
class SetObjectInspected : public BT::SyncActionNode {
   public:
   SetObjectInspected(const std::string& name, const BT::NodeConfig& config)
        : BT::SyncActionNode(name, config) {}
...
class TraverseDoor : public BT::SyncActionNode {
  public:
   TraverseDoor(const std::string& name, const BT::NodeConfig& config)
       : BT::SyncActionNode(name, config) {}
...
class EmergencyCall : public BT::SyncActionNode {
  public:
   EmergencyCall(const std::string& name, const BT::NodeConfig& config)
       : BT::SyncActionNode(name, config) {}
   ...
   // It is mandatory to define this static method.
   static BT::PortsList providedPorts() {
      return {BT::InputPort<std::string>("emergency_call")};
   }
};
